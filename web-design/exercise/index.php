   ...
   <!--visit https://www.w3schools.com/bootstrap/bootstrap_forms.asp search for forms template and use it.-->
    ...
    <form action="" name="form1" method="post">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="ssd" placeholder="Enter ssd" name="ssd">
        </div>
...
{
    mysqli_query($link,"insert into table2 values (NULL,'$_POST[model]' ,'$_POST[cpu]','$_POST[ram]','$_POST[ssd]')");
   ?>
...
{
    mysqli_query($link,"delete from table2 where model='$_POST[model]'");
    ?>
    <script type="text/javascript">
        window.location.href=window.location.href;
    </script>
...
{
    mysqli_query($link,"update table2 set cpu='$_POST[cpu]'where model='$_POST[model]'");
    ?>
    <script type="text/javascript">
        window.location.href=window.location.href;
    </script>
